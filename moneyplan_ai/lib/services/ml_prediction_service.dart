...
class MLPredictionService {
  ...
  Future<Map<String, dynamic>> predictLoanEligibility(Map<String, dynamic> inputData) async {
  ...
  Future<Map<String, dynamic>> _predictViaMLAPI(Map<String, dynamic> inputData) async {
  ...
  Future<Map<String, dynamic>> _predictViaRuleBasedSystem(Map<String, dynamic> inputData) async {
  ...
  Map<String, dynamic> _preprocessInputData(Map<String, dynamic> inputData) {
    ...
    processed['Property_Area'] = propertyArea == 'Urban' ? 2 : 
  ...
  String _makeDecisionTreePrediction(Map<String, dynamic> features) {
    ...
    // Property area
    if (features['Property_Area'] == 2) { // Urban
      score += 8;
    } else if (features['Property_Area'] == 1) { // Semiurban
      score += 5;
    }
  ...
  Future<Map<String, dynamic>?> getMLModelInfo() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5000/model-info'),
      ).timeout(const Duration(seconds: 5));
  ...
  Future<Map<String, dynamic>?> getMLFeatureImportance() async {
    try {
      final response = await http.get(
        Uri.parse('http://localhost:5000/feature-importance'),
      ).timeout(const Duration(seconds: 5));
